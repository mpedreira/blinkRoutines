"""
This file contains the endpoint to detect persons from a camera image using Face++ API.
"""
...
def detect_person_facepp(channel_id: str, cam_name: str):
    ...
    faces = PersonDetectorFacePP(config_instance).detect_faces(thumb)
